...
$config['database']['schema'] = 'administrador_gestao_ong';
$config['database']['user'] = 'administrador_gestao_ong';
$config['database']['pass'] = 'G07!brasil';
$config['database']['port'] = '8889'; // Nota: No MAMP a porta do MySQL costuma ser 8889 em vez de 3306
